...
st.set_page_config(page_title="Optimal Stopping Engine", layout="wide")
st.markdown("""
<style>
...
def find_latest_json(files):
    json_files = [f for f in files if f.endswith('.json') and 'optimal_stopping_' in f]
    if not json_files:
        return None
...
st.header("🏆 Top ETFs by Hold Score (Higher = Better to Hold)")
